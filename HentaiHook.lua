...
do
    ...
    Utility.SaveConfig = function(Config)
        writefile(
            "HentaiHook/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local Config = HttpService:JSONDecode(readfile("HentaiHook/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Utility.AddFolder("HentaiHook")
        Utility.AddFolder("HentaiHook/Caches")
        Utility.AddFolder("HentaiHook/Assets")
        Utility.AddFolder("HentaiHook/Assets/UI")
        Utility.AddFolder("HentaiHook/Configs")
        Utility.AddFolder("HentaiHook/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("HentaiHook/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("HentaiHook/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("HentaiHook/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("HentaiHook/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("HentaiHook/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.HentaiHook = Utility.AddImage("HentaiHook/Assets/UI/HentaiHook.png", "https://i.imgur.com/sfkDfQb.png")
        Library.Theme.Astolfo = Utility.AddImage("HentaiHook/Assets/UI/Astolfo.png", "https://i.imgur.com/T20cWY9.png")
        Library.Theme.Aiko = Utility.AddImage("HentaiHook/Assets/UI/Aiko.png", "https://i.imgur.com/1gRIdko.png")
        Library.Theme.Rem = Utility.AddImage("HentaiHook/Assets/UI/Rem.png", "https://i.imgur.com/ykbRkhJ.png")
        Library.Theme.Violet = Utility.AddImage("HentaiHook/Assets/UI/Violet.png", "https://i.imgur.com/7B56w4a.png")
        Library.Theme.Asuka = Utility.AddImage("HentaiHook/Assets/UI/Asuka.png", "https://i.imgur.com/3hwztNM.png")
...
do
    ...
    function Library.Window(Title, Size)
        ...
        function Window.ChangeAnime(Name)
            Anime.Data = (
                Name == "HentaiHook" and Library.Theme.HentaiHook or
            ...
            Anime.Size = (
                Name == "HentaiHook" and Vector2.new(412, 605) or
        ...
        function Window:AddSettingsTab(Additional)
            ...
            Theme:Dropdown({
                Title = "Theme",
                List = {"Default", "Neverlose", "Fatality", "Aimware", "Onetap", "Vape", "Gamesesne", "OldHentaiHook"},
                Default = "Default",
                Callback = function(Choosen)
                    ...
                    elseif Choosen == "OldHentaiHook" then
                        Library:UpdateTheme({
                            Outline = Color3.fromHex("#0a0a0a"),
